...
import { wire_color } from "../../data/wire_color";

export default function QuizWireColorScreen() {
  const router = useRouter();

  const [questions] = useState(() =>
    [...wire_color].sort(() => Math.random() - 0.5).slice(0, 14),
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* QUESTION */}
      <Text style={styles.question}> Ký hiệu: {currentQuestion.english}</Text>
